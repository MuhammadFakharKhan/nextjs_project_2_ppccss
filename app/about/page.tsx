    ...
    <div className="about-cont">
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <p className="text">
            Hi, My name is Muhammad Fakhar Khan. Im a passionate developer with a knack for creating seamless user experiences and robust web applications. My journey in tech began 2 years ago, and I have loved every moment of it. Whether I am working on a complex frontend interface or designing a sleek backend system, I always aim for excellence.
          </p>
          <p className="text">
            When I am not coding, you can find me on the cricket ground. I believe in continuous learning and always strive to improve my skills and knowledge in the ever-evolving tech landscape.
          </p>
          <p className="text">
